...
exports.checkIfLoggedIn = exports.registerInvite = exports.resetPassword = exports.sendResetPasswordEmail = exports.verifyAccount = exports.approve = exports.register = exports.logout = exports.login = void 0;
...
const checkIfLoggedIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.isAuthenticated()) {
        res.status(statusCode_1.default.OK).send({ loggedIn: true });
    }
    else {
        res.status(statusCode_1.default.OK).send({ loggedIn: false });
    }
});
